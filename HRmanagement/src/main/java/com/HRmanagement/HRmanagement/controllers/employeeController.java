...
public class employeeController {
	...
	public ResponseEntity<Optional<Employees>> findById(@PathVariable @NotNull Long id) {
		Optional<Employees> emp = emp_service.findById(id);
		return ResponseEntity.ok(emp);
	}

	@Operation(summary = " find employee by user name ")
	@RequestMapping(value = "/getUser/{username}", method = RequestMethod.GET)
	public ResponseEntity<Employees> findByusername(@PathVariable @NotNull String username) {
	...
	public ResponseEntity<List<Employees>> findAll() {
		List<Employees> emps = emp_service.findAll();
		return ResponseEntity.ok(emps);
	}

	@Operation(summary = " insert new employee ")
	@RequestMapping(value = "/insert", method = RequestMethod.POST)
	public ResponseEntity<Employees> insert(@RequestBody @Valid Employees emp) {
	...
	public ResponseEntity<Employees> update(@RequestBody @Valid Employees emp) {
